...
public abstract class AbstractPhizVarcharType<T> extends AbstractSingleColumnStandardBasicType<T> implements DiscriminatorType<T> {
    protected abstract static class AbstractPhizStringTypeDescriptor<T> extends AbstractTypeDescriptor<T> {
        protected Function<String, T> fromStrFunc;
        protected Function<T, String> toStrFunc;

        private final static long serialVersionUID = 0L;

        protected AbstractPhizStringTypeDescriptor(Class<T> typeClass, Function<String, T> fromStrFunc, Function<T, String> toStrFunc) {
            super(typeClass);
    ...
    protected AbstractPhizVarcharType(Class<T> typeClass, JavaTypeDescriptor<T> javaTypeDesc) {

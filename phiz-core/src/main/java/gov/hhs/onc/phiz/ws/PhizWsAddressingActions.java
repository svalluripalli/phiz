...
public final class PhizWsAddressingActions {
    private final static String IIS_PREFIX = PhizXmlNs.IIS + PhizXmlQnameUtils.REF_DELIM;
    private final static String IIS_HUB_PREFIX = PhizXmlNs.IIS_HUB + PhizXmlQnameUtils.REF_DELIM;

    private final static String SUBMIT_SINGLE_MSG_PREFIX = IIS_PREFIX + PhizWsNames.PORT_TYPE + PhizXmlQnameUtils.REF_DELIM;
    private final static String SUBMIT_SINGLE_MSG_HUB_PREFIX = IIS_HUB_PREFIX + PhizWsNames.PORT_TYPE_HUB + PhizXmlQnameUtils.REF_DELIM;

...
public final class PhizResourceUtils {
    ...
    public final static Comparator<Resource> LOC_FILE_NAME_COMPARATOR = Comparator.comparing(
        resource -> extractPath(resource, true),
        Comparator.nullsLast(((Comparator<String>) (resourcePath1, resourcePath2) -> {
            ...
            if (!resourceFilePath1.endsWith(resourceFilePath2) && !resourceFilePath2.endsWith(resourceFilePath1)) {
                String resourceFileName1 = org.springframework.util.StringUtils.getFilename(resourceFilePath1), resourceFileName2 =
                    org.springframework.util.StringUtils.getFilename(resourceFilePath2);

                if (!resourceFileName1.equals(resourceFileName2)) {
                    String resourceFileNameExt1 = org.springframework.util.StringUtils.getFilenameExtension(resourceFileName1), resourceFileNameExt2 =
                    ...
                    if (resourceFileNameExt1.equals(resourceFileNameExt2)
                        && !(resourceFileName1 = org.springframework.util.StringUtils.stripFilenameExtension(resourceFileName1)).equals((resourceFileName2 =
                        ...
                        if (StringUtils.endsWith(resourceFileName1, TEST_FILE_NAME_SUFFIX)
                            ...
                            return StringUtils.removeEnd(resourceFileName1, TEST_FILE_NAME_SUFFIX).compareTo(
                                StringUtils.removeEnd(resourceFileName2, TEST_FILE_NAME_SUFFIX));
                        }
                    }
                }
            }
    ...
    public final static Comparator<Resource> LOC_FILE_PATH_COMPARATOR = Comparator.comparing(resource -> extractPath(resource, true),
    ...
    public final static Comparator<Resource> LOC_PROTOCOL_COMPARATOR = Comparator.comparing(resource -> {
        try {
            if (resource instanceof FileSystemResource) {
                return 2;
            } else if ((resource instanceof UrlResource) && ResourceUtils.isJarURL(resource.getURL())) {
                return 1;
            }
    ...
    public final static Comparator<Resource> LOC_COMPARATOR = LOC_FILE_NAME_COMPARATOR.thenComparing(LOC_FILE_PATH_COMPARATOR)
